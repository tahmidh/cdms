    ...
    <!-- Carousel -->
      ...
      <div class="carousel-inner">
          <div class="item active">
            <img src="image/laptop.jpg" alt="First slide">
                    <!-- Static Header -->
                    <div class="header-text hidden-xs">
                        <div class="col-md-12 text-center">
                            <h2>
                              <span>Welcome to Criminal Database Management System</span>
                            </h2>
                            <br>
                            <h3>
                            ...
                            <br>
                            <div class="">
                                <a class="btn btn-theme btn-sm btn-min-block" href="login.php">Login</a><a class="btn btn-theme btn-sm btn-min-block" href="#">Register</a></div>
                        </div>
                    </div><!-- /header-text -->
          </div>
          <div class="item">
            <img src="image/laptop.jpg" alt="Second slide">
            <!-- Static Header -->
                    <div class="header-text hidden-xs">
                        <div class="col-md-12 text-center">
                            <h2>
