...
<body>
    ...
    <div id="wrapper">
        ...
        if(isset($_POST["submit"]))  {
            $sql_CR  = "INSERT INTO `criminal info` (`criminal id`, `name`, `address`, `age`, `ssn`, `gender`, `eye color`, `height`, `contact`) " ;
            $sql_CR .= "VALUES(";
            $sql_CR .= "NULL,'" . $_POST["name_criminal"] . "','" . $_POST["address_criminal"] . "','" . $_POST["age"] . "','" . $_POST["ssn"] . "','" . $_POST["gender"]."','" . $_POST["eye"] ."','".$_POST["height"]."','".$_POST["contact_criminal"]."'";
            $sql_CR .= ")";   
             
            $retval = mysql_query($sql_CR);
            if(! $retval )
            {
              die('Could not enter data in Criminal Info: ' . mysql_error());
            }
